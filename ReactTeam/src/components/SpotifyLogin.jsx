        ...
        <div id='introHeader'>
          <div className='container'>
            ...
            <div className='member'>
              <button className='signup' onClick={handleLogin}>회원가입</button>
              <button className='login round' onClick={handleLogin}>로그인</button>
            </div>
          </div>
        </div>
        <div className='content'>
          <div id='visual'>
            <div className='visual-logo'><img src={logoColor} className="logo" alt="Spotify Logo" /></div>
            <p className='intro-text'>스포티파이 API로 만든<br />
              <span>맞춤 음악 스트리밍 서비스</span>입니다.
            </p>
            <div className='intro-btn'>
              <ul>
                <li><button className='login round' onClick={handleLogin}>로그인</button></li>
                <li><button className='more'>둘러보기</button></li>
              </ul>
            </div>
          </div>
          <div className='intro-text-con'>
            <p className='intro-text'>API로 데이터를 받아서<br />
              <span>AI모델링</span>을 통해<br />
          ...
          <div id='process'>
            <div className='process-box proc-api'>
              <div className='text'>
                ...
                <div className='txt'>
                  로그인, 앨범, 아티스트, 카테고리, 플레이어, 플레이리스트, 검색 등<br />
                  스포티파이에서 제공하는 기능을 사용
                </div>
              </div>
            ...
            <div className='process-box proc-recomend'>
              ...
              <div className='process-con'>
                <div className='proc-recomend-title'>회원님이 좋아하실 노래</div>
                <ul>
                  <li>
                    <div className='thumb'><img src={process_api_recomend01} className="logo" alt="thumb" /></div>
                    <div className='title'>
                      <div className='tit'>그대만 있다면 (여름날 우리 X 너드커넥션 (Nerd Connection))</div>
                      <div className='txt'>너드커넥션 (Nerd Connection)</div>
                    </div>
                    <div className='btn'>
                      <button><img src={play} className="logo" alt="Spotify Logo" /></button>
                      <button><img src={dots_three_vertical} className="logo" alt="option" /></button>
                    </div>
                  </li>
                  <li>
                    <div className='thumb'><img src={process_api_recomend02} className="logo" alt="thumb" /></div>
                    <div className='title'>
                  ...
                  <li>
                    <div className='thumb'><img src={process_api_recomend03} className="logo" alt="thumb" /></div>
                    <div className='title'>
          ...
          <div className='intro-text-con'>
            ...
            <div className='intro-btn'>
              <ul>
                <li><button className='login round' onClick={handleLogin}>나에게 맞는 음악 듣기</button></li>
              </ul>
            </div>
          </div>
        </div>
